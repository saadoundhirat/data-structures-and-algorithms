...
const toLastNames = people => {
  // Solution code here...
  let arrNames = people.map((value,indx)=> {
...
const addValues = (arr) => {
  // Solution code here...
  let values  = arr.reduce((acc ,element) =>{
    acc += element;
    return acc;
  },0);
  return values;
...
const addPurchases = (arr) => {
  // Solution code here...
  let amount  = arr.reduce((acc ,value ) => {
...
const returnNames = (arr) => {
  // Solution code here...
  let namesArray = arr.reduce((acc , value, index)=>{
    // acc.push(value.name);
...
const reversedString = (str) => {
  ...
  'hasdsad' ['h','a']
  let newString = arrayString.reduce((acc, letter)=>{
         acc = letter + acc;
            return acc;
  },'')
  return newString;
...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  let totalNum = arr.reduce((acc , value)=>{
